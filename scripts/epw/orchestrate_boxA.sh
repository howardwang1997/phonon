...
TMUX= tmux new-session -d -s j030 "env DEGAUSS=0.03 NQ=3 NKF=24 WORK=/data/nbse2_d030 RESULT_CSV=/root/res_d030.csv bash $S/nbse2_epw_full.sh > /root/j030.log 2>&1"
TMUX= tmux new-session -d -s j040 "env DEGAUSS=0.04 NQ=3 NKF=24 WORK=/data/nbse2_d040 RESULT_CSV=/root/res_d040.csv bash $S/nbse2_epw_full.sh > /root/j040.log 2>&1"
