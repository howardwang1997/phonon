...
**诚实边界**:固定-D₀ + healing-B 律已能复现 Kohn 熔化(MAE 0.20);backbone 必须用 dg0.08(宽 smearing dg0.14/0.20 畸变 fc₂)。径向 α(R) learnable-D₀ 边际 → 真正抓住突变的是 **B(T) healing 形参**(已用);进一步收紧靠 Line B(retrain backbone,V100 进行中)。
